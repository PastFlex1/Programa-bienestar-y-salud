...
const sessionsData: { [key: string]: MeditationSession[] } = {
  ...
  deepSleep: [
    ...
    { title: { es: "Noche Serena", en: "Serene Night" }, description: { es: "Música y guía para dormir.", en: "Music and guidance for sleep." }, lengthMinutes: 30, type: { es: "Sueño", en: "Sleep" }, imageUrl: "https://placehold.co/600x400.png", imageHint: "moonlit forest" },
    { title: { es: "Relajación Nocturna", en: "Nightly Relaxation" }, description: { es: "Libera el día antes de dormir.", en: "Release the day before sleeping." }, lengthMinutes: 15, type: { es: "Sueño", en: "Sleep" }, imageUrl: "https://placehold.co/600x400.png", imageHint: "cozy bedroom" },
  ],
  intenseFocus: [
  ...
  anxietyReduction: [
    ...
    { title: { es: "Anclaje en el Presente", en: "Anchor in the Present" }, description: { es: "15 minutos para conectar con el ahora.", en: "15 minutes to connect with the now." }, lengthMinutes: 15, type: { es: "Ansiedad", en: "Anxiety" }, imageUrl: "https://placehold.co/600x400.png", imageHint: "person sitting" },
    { title: { es: "Suelta la Preocupación", en: "Let Go of Worry" }, description: { es: "Una sesión de 20 minutos para liberarte.", en: "A 20-minute session to free yourself." }, lengthMinutes: 20, type: { es: "Ansiedad", en: "Anxiety" }, imageUrl: "https://placehold.co/600x400.png", imageHint: "dandelion seeds" },
  ],
   morningStart: [
