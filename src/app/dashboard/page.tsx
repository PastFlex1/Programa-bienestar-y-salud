...
const sessionsData: { [key: string]: MeditationSession[] } = {
  ...
  intenseFocus: [
    { title: { es: "Claridad Mental", en: "Mental Clarity" }, description: { es: "10 minutos para una mente aguda.", en: "10 minutes for a sharp mind." }, lengthMinutes: 10, type: { es: "Enfoque", en: "Focus" }, imageUrl: "/enfoque/enfoque1.png", imageHint: "focused work", audioUrl: "/audio/Meditar8.m4a" },
    { title: { es: "Concentración Total", en: "Total Concentration" }, description: { es: "15 minutos para eliminar distracciones.", en: "15 minutes to eliminate distractions." }, lengthMinutes: 15, type: { es: "Enfoque", en: "Focus" }, imageUrl: "/enfoque/enfoque2.png", imageHint: "geometric patterns", audioUrl: "/audio/Meditar9.m4a" },
    { title: { es: "Potencia tu Productividad", en: "Boost Your Productivity" }, description: { es: "Un impulso de 20 minutos para tu trabajo.", en: "A 20-minute boost for your work." }, lengthMinutes: 20, type: { es: "Enfoque", en: "Focus" }, imageUrl: "/enfoque/enfoque3.png", imageHint: "light bulb", audioUrl: "/audio/armonia.m4a" },
  ],
  anxietyReduction: [
    { title: { es: "Paz Interior", en: "Inner Peace" }, description: { es: "Encuentra la calma en 10 minutos.", en: "Find calm in 10 minutes." }, lengthMinutes: 10, type: { es: "Ansiedad", en: "Anxiety" }, imageUrl: "/ansiedad/ansiedad1.jpg", imageHint: "zen garden", audioUrl: "/audio/Meditar.m4a" },
  ...
  unwindEvening: [
    { title: { es: "Final del Día", en: "End of Day" }, description: { es: "Desconecta y relájate en 15 minutos.", en: "Disconnect and relax in 15 minutes." }, lengthMinutes: 15, type: { es: "Relajación", en: "Relaxation" }, imageUrl: "/sueño/sueño4.jpg", imageHint: "sunset view", audioUrl: "/audio/lofi.m4a" },
    { title: { es: "Pausa Nocturna", en: "Evening Pause" }, description: { es: "Reflexiona y calma tu mente antes de dormir.", en: "Reflect and calm your mind before sleep." }, lengthMinutes: 10, type: { es: "Calma", en: "Calm" }, imageUrl: "/sueño/sueño5.jpg", imageHint: "cup of tea", audioUrl: "/audio/lofi2.mp4" },
  ],
  walkingMeditation: [
    { title: { es: "Paseo Consciente", en: "Mindful Walk" }, description: { es: "Conecta con cada paso que das.", en: "Connect with every step you take." }, lengthMinutes: 20, type: { es: "Caminar", en: "Walking" }, imageUrl: "/cocentracion/concentracion3.jpg", imageHint: "forest path", audioUrl: "/audio/Meditar4.m4a" },
    { title: { es: "Caminata Urbana", en: "Urban Walk" }, description: { es: "Encuentra la paz en la ciudad.", en: "Find peace in the city." }, lengthMinutes: 15, type: { es: "Caminar", en: "Walking" }, imageUrl: "/cocentracion/concentracion4.jpg", imageHint: "city park", audioUrl: "/audio/Meditar5.m4a" },
  ],
  bodyScan: [
    { title: { es: "Escaneo Corporal Profundo", en: "Deep Body Scan" }, description: { es: "25 minutos de conexión con tu cuerpo.", en: "25 minutes of connection with your body." }, lengthMinutes: 25, type: { es: "Escaneo Corporal", en: "Body Scan" }, imageUrl: "/cocentracion/concentracion5.jpg", imageHint: "human anatomy", audioUrl: "/audio/Meditar6.m4a" },
    { title: { es: "Relajación de Pies a Cabeza", en: "Head to Toe Relaxation" }, description: { es: "Libera la tensión acumulada.", en: "Release accumulated tension." }, lengthMinutes: 15, type: { es: "Escaneo Corporal", en: "Body Scan" }, imageUrl: "/cocentracion/concentracion6.jpg", imageHint: "person stretching", audioUrl: "/audio/Meditar7.m4a" },
  ],
  focusAndRelax: [
    { title: { es: "Foco Relajado", en: "Relaxed Focus" }, description: { es: "Encuentra tu centro para trabajar mejor.", en: "Find your center to work better." }, lengthMinutes: 15, type: { es: "Foco/Relax", en: "Focus/Relax" }, imageUrl: "/cocentracion/concentracion7.jpg", imageHint: "zen office", audioUrl: "/audio/Meditar8.m4a" },
    { title: { es: "Calma y Concentración", en: "Calm and Concentration" }, description: { es: "El equilibrio perfecto para tu mente.", en: "The perfect balance for your mind." }, lengthMinutes: 20, type: { es: "Foco/Relax", en: "Focus/Relax" }, imageUrl: "/cocentracion/concentracion8.jpg", imageHint: "stack of stones", audioUrl: "/audio/Meditar9.m4a" },
  ],
  stressAndSleep: [
    { title: { es: "Adiós Estrés, Hola Sueño", en: "Goodbye Stress, Hello Sleep" }, description: { es: "Prepara tu mente para un sueño reparador.", en: "Prepare your mind for a restful sleep." }, lengthMinutes: 18, type: { es: "Estrés/Sueño", en: "Stress/Sleep" }, imageUrl: "/sueño/sueño6.png", imageHint: "calm clouds", audioUrl: "/audio/lofi2.mp4" },
