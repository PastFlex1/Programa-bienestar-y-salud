...
const sessionsData: { [key: string]: MeditationSession[] } = {
  stressRelief: [
    { title: { es: "Calma Rápida", en: "Quick Calm" }, description: { es: "5 minutos para liberar tensión.", en: "5 minutes to release tension." }, lengthMinutes: 8, type: { es: "Estrés", en: "Stress" }, imageUrl: "/alivioestres/estres1.png", imageHint: "serene lake", audioUrl: "/audio/estres.mp3" },
    { title: { es: "Respiración Consciente", en: "Mindful Breathing" }, description: { es: "10 minutos de respiración para el estrés.", en: "10 minutes of breathing for stress." }, lengthMinutes: 12, type: { es: "Estrés", en: "Stress" }, imageUrl: "/alivioestres/estres2.png", imageHint: "person meditating", audioUrl: "/audio/estres.mp3" },
  ...
  deepSleep: [
    { title: { es: "Viaje al Sueño", en: "Journey to Sleep" }, description: { es: "20 minutos para un descanso profundo.", en: "20 minutes for a deep rest." }, lengthMinutes: 18, type: { es: "Sueño", en: "Sleep" }, imageUrl: "/sueño/sueño1.png", imageHint: "starry night", audioUrl: "/audio/sueño.mp3" },
    { title: { es: "Noche Serena", en: "Serene Night" }, description: { es: "Música y guía para dormir.", en: "Music and guidance for sleep." }, lengthMinutes: 25, type: { es: "Sueño", en: "Sleep" }, imageUrl: "/sueño/sueño2.png", imageHint: "moonlit forest", audioUrl: "/audio/sueño.mp3" },
