...
const sessionsData: { [key: string]: MeditationSession[] } = {
  stressRelief: [
    { title: { es: "Calma Rápida", en: "Quick Calm" }, description: { es: "5 minutos para liberar tensión.", en: "5 minutes to release tension." }, lengthMinutes: 5, type: { es: "Estrés", en: "Stress" }, imageUrl: "/alivioestres/estres1.png", imageHint: "serene lake", audioUrl: "/audio/estres.mp3" },
    { title: { es: "Respiración Consciente", en: "Mindful Breathing" }, description: { es: "10 minutos de respiración para el estrés.", en: "10 minutes of breathing for stress." }, lengthMinutes: 10, type: { es: "Estrés", en: "Stress" }, imageUrl: "/alivioestres/estres2.png", imageHint: "person meditating", audioUrl: "/audio/estres.mp3" },
    { title: { es: "Pausa Relajante", en: "Relaxing Pause" }, description: { es: "Una pausa de 15 minutos en tu día.", en: "A 15-minute break in your day." }, lengthMinutes: 15, type: { es: "Estrés", en: "Stress" }, imageUrl: "/alivioestres/estres3.jpg", imageHint: "calm waves", audioUrl: "/audio/estres.mp3" },
  ],
  deepSleep: [
    ...
    { title: { es: "Noche Serena", en: "Serene Night" }, description: { es: "Música y guía para dormir.", en: "Music and guidance for sleep." }, lengthMinutes: 30, type: { es: "Sueño", en: "Sleep" }, imageUrl: "/sueño/sueño2.png", imageHint: "moonlit forest", audioUrl: "/audio/sueño.mp3" },
    { title: { es: "Relajación Nocturna", en: "Nightly Relaxation" }, description: { es: "Libera el día antes de dormir.", en: "Release the day before sleeping." }, lengthMinutes: 15, type: { es: "Sueño", en: "Sleep" }, imageUrl: "/sueño/sueño3.png", imageHint: "cozy bedroom", audioUrl: "/audio/sueño.mp3" },
  ],
  intenseFocus: [
