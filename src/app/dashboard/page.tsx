...
const sessionsData: { [key: string]: MeditationSession[] } = {
  ...
  deepSleep: [
    { title: { es: "Viaje al Sueño", en: "Journey to Sleep" }, description: { es: "20 minutos para un descanso profundo.", en: "20 minutes for a deep rest." }, lengthMinutes: 20, type: { es: "Sueño", en: "Sleep" }, imageUrl: "/sueño/sueño1.png", imageHint: "starry night" },
    { title: { es: "Noche Serena", en: "Serene Night" }, description: { es: "Música y guía para dormir.", en: "Music and guidance for sleep." }, lengthMinutes: 30, type: { es: "Sueño", en: "Sleep" }, imageUrl: "/sueño/sueño2.png", imageHint: "moonlit forest" },
